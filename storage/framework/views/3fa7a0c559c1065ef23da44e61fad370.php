        ...
        <form action="<?php echo e(route('professor.store')); ?>" method="POST">
            ...
            <div class="row mb-3 mt-3">
                <div class="col-6">
                    ...
                    <input type="number" class="form-control" maxlength="60" name="idade" placeholder="Idade">

                    <label for="materia" class="form-label mt-2">Materia</label>
                    <input type="text" class="form-control" maxlength="60" name="materia" placeholder="Materia">
...
</html><?php /**PATH C:\Users\aluno\Desktop\laravel-crud-master (2)\laravel-crud-master\laravel-crud-master\resources\views/professor/create.blade.php ENDPATH**/ ?>